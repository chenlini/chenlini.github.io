...
\begin{equation}
\begin{aligned}
\min\limits_{\mathbf{W_R},\mathbf{W_B}} &\sum_{i\in \mathcal{D}}^{}\frac{1}{2}\| \mathbf{r}_i-\mathbf{R}\mathbf{w_R}_i^T\|^2_F + \frac{1}{2}\|\mathbf{b}_i-\mathbf{B}\mathbf{w_B}_i^T\|^2_F+\gamma \|\mathbf{w_R}_i-\mathbf{w_B}_i\|_F^2+\alpha \|\mathbf{w_R}_i\|_F^2 +\beta \|\mathbf{w_B}_i\|_F^2\\
\textrm{s.t.}& \quad diag (\mathbf{W_R})=0 \\
&\quad diag (\mathbf{W_B})=0
\end{aligned}
\end{equation}
